...
public class Tools5eLinkifier {
    ...
    private String linkClassFeature(String linkText, String featureKey) {
        ...
        int level = IndexFields.level.intOrThrow(featureNode) < 3 ? 3 : IndexFields.level.intOrThrow(featureNode); // required
    ...
    public String linkSubclassFeature(String linkText,
        ...
        String level = Integer.parseInt(Tools5eFields.level.getTextOrEmpty(featureJson)) < 3 ? "3"
